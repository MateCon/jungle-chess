      ...
      <>
        ...
        <div className='w-screen h-fit min-h-screen bg-background-900 pt-20 md:pt-0 md:pl-20'>
          ...
          <Game
            ...
            <div className="mt-16">
            <button type="button" className="bg-background-300 hover:bg-background-100 transition text-background-900 font-bold rounded-sm mr-4 text-2xl h-16 w-48">Unranked</button>
            <div className="mt-16">
