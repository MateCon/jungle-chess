      ...
      <>
        ...
        <div className='w-screen h-fit min-h-screen bg-background-900 pt-20 md:pt-0 md:pl-20'>
          <main className="w-full min-h-screen pt-10 place-content-center flex flex-row">
            ...
            <div className="flex flex-col justify-center items-center rounded-md shadow-sm mx-8 px-8 box-content bg-background-700 h-[600px] w-[400px]">
            <h1
            ...
            <button type="button" className="bg-primary-500 hover:bg-primary-400 transition text-background-900 font-bold mr-4 text-2xl h-16 w-48 justify-center">Google</button>
            <div className="mt-10">
