      ...
      <>
        ...
        <div className='w-screen h-fit min-h-screen bg-background-900 pt-20 md:pt-0 md:pl-20'>
          <main className="w-full min-h-screen pt-10 place-content-center flex flex-row">
            ...
            <div className="flex flex-col justify-center items-center rounded-md shadow-sm mx-8 px-8 box-content bg-background-700 h-[1000px] w-[600px]">
            <h2
            ...
            <div className="flex flex-col justify-center items-center rounded-md shadow-sm mx-8 px-8 mt-10 box-content bg-background-700 h-[1000px] w-[600px]">
            ...
            <div
              ...
              >           
                ...
                <span className="text-white mr-2">:</span>
                <span className="text-white">This kind of square is located on the sides and next to the lair. Its function is to weaken all the pieces which get into there 
                ...
                <span className="text-white">There are 8 pieces for each player which have different features.</span>
                <span className="text-white">They are going to be listed from least valuable to most ones</span><br/>
